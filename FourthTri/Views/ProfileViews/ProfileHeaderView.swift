  ...
  var body: some View {
    ...
    VStack {
      ...
      HStack {
        ...
        ProfileRectangleSection(
          RectangleImage: "trophy",
          RectangleTitle: """
                          Placeholder
                          Title
                          """
    ...
    .sheet(isPresented: $isHelpShowing) { ProfileSOSView() }
  }
}
  ...
  var body : some View {
    ...
    ZStack {
      ...
      if showEdit {
        ...
        Button {
          // TODO: PROFILE PICTURE EDIT ACTION
        } label: {

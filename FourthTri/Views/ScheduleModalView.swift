...
struct ScheduleModalView: View {
    var body: some View {
        VStack {
            ...
            ModalHeaderView(headerTitle: "Schedule", addButton: true)
            
            ScrollView {
                ExpandedScheduleView(scheduleDate: "1/31", scheduleTitle: "Fireside Chat (Sleep Basics)", scheduleTime: "12:00 PM")
            }
